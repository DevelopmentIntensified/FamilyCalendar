			...
			<div class="rounded-2xl border border-amber-200 bg-white p-8 shadow-lg">
				...
				<div class="rounded-lg bg-amber-50 p-4">
					<p class="text-sm text-amber-800">
						Click the confirmation link in the email we just sent you. This completes your double
						opt-in and adds you to the waitlist.
					</p>
				</div>
				<div class="mt-6 text-center">
					<p class="text-sm text-slate-500">
						Didn't receive it? <a
							href="/waitlist"
							class="font-medium text-amber-600 hover:text-amber-700">Try again</a
						>
					</p>
				</div>
			</div>
				...
				<div class="mt-6 text-center text-sm text-slate-500">
					<p>
						By joining, you agree to our <a
							href="/privacy"
							class="font-medium text-amber-600 hover:text-amber-700">Privacy Policy</a
						>
					</p>
				</div>
			</div>
