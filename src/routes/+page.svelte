...
<div>
		...
		<div class="px-2">
			<div class="-mx-2 flex flex-auto flex-wrap gap-y-5">
				<div class="px-10 md:w-1/3">
					<div class="h-96 rounded-2xl bg-primary-300">
				...
				<div class="px-10 md:w-1/3">
					<div class="h-96 rounded-2xl bg-primary-300">
						<div class="w-full py-10 text-center">
							...
							<h3 class="px-1 text-xl font-bold">Color Each Family Member's Events</h3>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="end" class="relative bg-secondary-100 px-10 py-3 text-center">
		<div class="h-64 w-full text-center">
			...
			<p class="mx-20 mb-5 rounded-lg p-2 font-mono text-slate-700 opacity-80">
