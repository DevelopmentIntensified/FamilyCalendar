...
<div>
	<section id="welcome" class="relative py-52 text-center md:py-52">
		...
		<div class="absolute inset-0 m-auto my-10 rounded-lg p-10 lg:w-3/6">
			...
			<button class="rounded bg-secondary-500 p-3 my-3 text-xl font-bold text-white"
		...
		<div class="px-2">
			<div class="-mx-2 flex flex-auto flex-wrap gap-y-5">
				<div class="m-auto px-2 lg:w-1/3 lg:px-10">
					<div class="h-96 w-72 md:w-72 sm:w-96 rounded-2xl bg-primary-300 lg:max-w-none xl:w-full">
				...
				<div class="m-auto px-2 lg:w-1/3 lg:px-10">
					<div class="h-96 md:w-72 w-72 sm:w-96 rounded-2xl bg-primary-300 lg:max-w-none xl:w-full">
						<div class="w-full p-2 py-10 text-center">
