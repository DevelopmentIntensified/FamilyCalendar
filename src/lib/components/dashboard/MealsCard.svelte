						...
						{#each group.items as meal (meal.id)}
							...
							>
								...
								<button
									...
									class="shrink-0 rounded-full p-1.5 text-slate-300 sm:opacity-0 transition-all hover:bg-red-50 hover:text-red-500 sm:group-hover:opacity-100 disabled:opacity-40"
