...
<div class="relative">
	...
	>
		...
		<svg
			class="h-4 w-4 shrink-0 text-slate-400 transition-transform {showDropdown
				? 'rotate-180'
				: ''}"
			fill="none"
			viewBox="0 0 24 24"
		...
		>
			{#each calendarIds as cal}
				<button
					...
					class="flex w-full items-center gap-3 px-4 py-3 text-left text-sm transition-colors hover:bg-slate-50 {value ===
					cal.id
