...
<div class="mb-2 bg-white pt-4">
	<!-- Modern Header -->
	<div
		class="mb-6 flex flex-col items-center gap-3 px-4 sm:flex-row sm:flex-wrap sm:justify-between sm:gap-x-4 sm:gap-y-2"
	>
		<div class="flex w-full items-center justify-between gap-3 sm:w-auto sm:justify-start">
			...
			<div class="relative">
				...
				{#if showMiniPicker}
					<div
						class="absolute left-0 top-full z-20 mt-2 w-64 rounded-xl border border-slate-200 bg-white p-4 shadow-xl"
					>
		...
		<div
			class="flex w-full min-w-0 items-center justify-between gap-2 sm:w-auto sm:flex-wrap sm:justify-end"
		>
			<!-- View Toggle -->
